      ...
      <div className="preview">
        ...
        />
        {
          this.props.showSpecs ? (
            <ul className="specs">
              <li>
                <span className="specs-value">{this.specs?.range ?? ' - '}km</span>
                <span className="specs-label">Reichweite</span>
              </li>
              <li>
                <span className="specs-value">{this.specs?.top_speed ?? ' - '}km/h</span>
                <span className="specs-label">Geschwindigkeit</span>
              </li>
              <li>
